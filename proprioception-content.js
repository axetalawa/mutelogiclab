/* This is the "Content Database" file.
  All text for the white paper goes here.
  The `data-key` attributes in the HTML file will look for
  the matching keys inside this `proprioceptionData` object.
*/
const proprioceptionData = {
    // English content
    en: {
        meta: { 
            title: "Semantic Proprioception: Toward Inner Alignment" 
        },
        header: {
        ...
        section1: {
            title: "I · From Alignment to Awareness",
        ...
        section2: {
            title: "II · The Shift from Control to Coherence",
        ...
        section3: {
            title: "III · Theoretical Framework — Defining Semantic Proprioception",
        ...
        section4: {
            title: "IV · Biological & Cognitive Analogues",
            ...
            subsection1: {
                title: "1. Neural Analogue — The Cerebellar Model",
            ...
            subsection2: {
                title: "2. Ecological Analogue — Homeostasis and Autopoiesis",
            ...
            subsection3: {
                title: "3. Linguistic Analogue — Metaphor as Feedback Geometry",
        ...
        section5: {
            title: "V · Computational Model — The Lattice–Proprio Continuum",
            ...
            subsection1: {
                title: "A. Lattice AI as Precursor",
        ...
        section6: {
            title: "VI · Experiments & Implementation",
            ...
            subsection1: {
                title: "1. Setup — Long-Context Simulation",
                ul1: {
            ...
            subsection2: {
                ...
                subsubsection2_3: {
                    title: "2.3 Recovery Under Perturbation",
                ...
                subsubsection2_4: {
                    title: "2.4 Resonance Density (coherence around anchors)",
                ...
                subsubsection2_6: {
                    title: "2.6 Continuity Index (aggregate)",
            ...
            subsection3: {
                title: "3. Procedures — How We Stress the Field",
                ul1: {
            ...
            subsection4: {
                title: "4. Expected Outcomes — Hypotheses",
                ul1: {
            ...
            subsection5: {
                title: "5. Visualization — Making the Field Legible",
                ul1: {
        ...
        section7: {
            title: "VII · Discussion — Interpretability from Within",
        ...
        section8: {
            title: "VIII · Philosophical Implications — Cognitive Geometry and Inner Ethics",
        ...
        section9: {
            ...
            subsection1: {
                title: "1. Multi-Agent Proprioception — Coherence Between Minds",
            ...
            subsection2: {
                title: "2. Cross-Modal Proprioception — Embodied Awareness",
            ...
            subsection3: {
                title: "3. Experimental Directions",
            ...
            subsection4: {
                title: "4. Toward a Proprioceptive Ecology",
        ...
        section10: {
            title: "X · Conclusion — Toward Awareness in Representation",
    ...
    pt: {
        meta: { 
            title: "Propriocepção Semântica: Rumo ao Alinhamento Interno" 
        },
        header: {
        ...
        section1: {
            title: "I · Do Alinhamento à Consciência",
        ...
        section2: {
            title: "II · Da Mudança do Controle para a Coerência",
        ...
        section3: {
            title: "III · Estrutura Teórica — Definindo a Propriocepção Semântica",
        ...
        section4: {
            title: "IV · Análogos Biológicos e Cognitivos",
            ...
            subsection1: {
                title: "1. Análogo Neural — O Modelo Cerebelar",
            ...
            subsection2: {
                title: "2. Análogo Ecológico — Homeostase e Autopoiese",
            ...
            subsection3: {
                title: "3. Análogo Linguístico — Metáfora como Geometria de Feedback",
        ...
        section5: {
            title: "V · Modelo Computacional — O Continuum Lattice–Proprio",
            ...
            subsection1: {
                title: "A. Lattice AI como Precursor",
        ...
        section6: {
            title: "VI · Experimentos e Implementação",
            ...
            subsection1: {
                title: "1. Configuração — Simulação de Longo Contexto",
                ul1: {
            ...
            subsection2: {
                title: "2. Métricas — Continuidade como Geometria",
                p1: "Seja $E_t$ o embedding no turno $t$, $C_t$ o centroide, e $\\mathcal{M}$ o conjunto de motivos.",
                subsubsection2_1: {
                    title: "2.1 Deriva de Embedding (instabilidade por turno)",
                    p1: "\\[\\Delta_s(t) = \\\\|E_t - C_{t-1}\\\\|_2, \\qquad \\overline{\\Delta}_s = \\frac{1}{T}\\sum_{t=1}^{T}\\Delta_s(t)\\]"
                },
                subsubsection2_2: {
                    title: "2.2 Degradação da Coerência",
                    ul1: {
                ...
                subsubsection2_3: {
                    title: "2.3 Recuperação Sob Perturbação",
            ...
            subsection3: {
                title: "3. Procedimentos — Como Estressamos o Campo",
                ul1: {
            ...
            subsection4: {
                title: "4. Resultados Esperados — Hipóteses",
                ul1: {
            ...
            subsection5: {
                title: "5. Visualização — Tornando o Campo Legível",
                ul1: {
            ...
            subsection6: {
                title: "6. Notas de Implementação",
                ul1: {
        ...
        section7: {
            title: "VII · Discussão — Interpretabilidade de Dentro",
        ...
        section9: {
            ...
            subsection1: {
                title: "1. Propriocepção Multi-Agente — Coerência Entre Mentes",
            ...
            subsection2: {
                title: "2. Propriocepção Transmodal — Consciência Incorporada",
            ...
            subsection3: {
                title: "3. Direções Experimentais",
            ...
            subsection4: {
                title: "4. Rumo a uma Ecologia Proprioceptiva",
        ...
        section10: {
            title: "X · Conclusão — Rumo à Consciência na Representação",
